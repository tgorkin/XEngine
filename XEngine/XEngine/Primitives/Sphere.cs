...
namespace XEngine {
    class Sphere : GeometricPrimitive {
        ...
        public Sphere( Game game, Color color, float diameter, int tessellation )
            : base( game, color ) {
                m_diameter = diameter;
                m_tessellation = tessellation;
        }

        public Sphere( Game game, Color color, float diameter )
            : this( game, color, diameter, DEFAULT_TESSELLATION ) {
        }

        public Sphere( Game game, Color color )
            : this( game, color, DEFAULT_DIAMETER, DEFAULT_TESSELLATION ) {
        }
